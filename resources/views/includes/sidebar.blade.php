 ...
 <nav class="sidebar">
     <div class="logo d-flex justify-content-between">
         <a class="large_logo" href="index-2.html"><img src="{{ asset('public/img/b2clogo.png') }}" alt=""></a>
         <a class="small_logo" href="index-2.html"><img src="{{ asset('public/img/b2clogo.png') }}" alt=""></a>
         <div class="sidebar_close_icon d-lg-none">
             <i class="ti-close"></i>
         </div>
     </div>
     <ul id="sidebar_menu" class="text-center">
         <li class="text-center">
             <a href="{{url('home')}}" aria-expanded="false">
                 <div class="nav_icon_small">
                     <img src="{{ asset('public/img/menu-icon/dashboard.svg') }}" alt="">
                 </div>
                 <div class="nav_title">
                     <span>Dashboard</span>
                 </div>
        ...
        <li>
         ...
         <li>
             <a href="{{url('categories')}}" aria-expanded="false">
                 <div class="nav_icon_small" >
         ...
         <li>
             <a href="{{url('sub-categories')}}" aria-expanded="false">
                 <div class="nav_icon_small" >
                     <i class="fas fa-layer-group" style="margin-right:0px;"></i>
                 </div>
                 <div class="nav_title">
         ...
         <!-- <h4 class="menu-text"><span>Product</span> <i class="fas fa-ellipsis-h"></i> </h4> -->
         <li>
             <a class="has-arrow" href="#" aria-expanded="false">
                 <div class="nav_icon_small">
                     <img src="{{ asset('public/img/menu-icon/4.svg') }}" alt="">
                 </div>
                 <div class="nav_title">
                     <span>Product</span>
                 </div>
