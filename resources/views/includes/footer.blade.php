        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer_iner text-center">
                    <p>2021 © Influence - Designed by <a href="#"> <i class="ti-heart"></i> </a><a href="#"> SSS Sybertech Pvt. Ltd.</a></p>
                </div>
            </div>
        </div>
    </div>
...
//     });
    ...
    $(document).ready(function () {
        ...
        $('#subcategory').on("select2:open", function (e) {
            // alert("yes");
            // $(this).data("open", true);
            flg1++;
            if (flg1 == 1) {
                $this_html1 = $('#wrp2').html();
                // console.log($this_html);
                $('.select2-results').append("<div class='select2-results__option'>" +
                    $this_html1 + "</div>");
    ...
    $(document).ready(function () {
        ...
        $('#discount').on("select2:open", function (e) {
            ...
            flg2++;
            if (flg2 == 1) {
                $this_html2 = $('#wrp3').html();
                console.log($this_html2);
                $('.select2-results').append("<div class='select2-results__option'>" +
                    $this_html2 + "</div>");
            }
        });
...
//<![CDATA[
  bkLib.onDomLoaded(function() {
        ...
        new nicEditor({fullPanel : true}).panelInstance('productdesc');
        // new nicEditor({buttonList : ['fontSize','bold','italic','underline','strikeThrough','subscript','superscript','html','image']}).panelInstance('productdesc');
  ...
  //]]>
   ...
   // Initialize select2
//    $("#att_type").select2();
   $("#att_type").select2({ placeholder: "Select Type",width: "resolve", });  
   $("#att_subtype").select2({ placeholder: "Select Sub Type",width: "resolve", });  
   $("#category").select2({ placeholder: "Select Category",width: "resolve", });  
   $("#subcategory").select2({ placeholder: "Select Sub Category",width: "resolve", });  
   $("#discount").select2({ placeholder: "Select Discount",width: "resolve", });  
  </script>
