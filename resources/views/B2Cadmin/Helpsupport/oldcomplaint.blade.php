            ...
            <div class="mb-2 mt-2 contentheading">
                ...
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Your Complaints</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
                        ...
                        <ul class="nav nav-pills flex-column gap-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('old-complaint') ? 'active' : '' }}"
                                    href="old-complaint">
                                    <span class="bi bi-wallet2 me-3"></span>Your Complaints</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-9 ">
                <form method="get" id="form1" action="http://34.72.9.224/quickWebsite/b2c_admin/settings">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="card-title mb-4">Your Complaints</h6>
                        </div>
                    </div>
